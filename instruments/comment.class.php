    ...
    global $user;
        ...
        if ($commentnum) {
            ...
            while ( $line = mysql_fetch_array( $result, MYSQL_NUM ) ) {
                     ...
                     $comments_item = new Comments_ItemLol($line[0], $this->st_subdir);
...
class Comments_ItemLol extends ItemLol {
private $user_id;
private $parent_obj;
    ...
    public function Show($for_user = false) {
        ...
        $verified    = ($this_user->verified())? '<div class="label label-success verified_nick" data-toggle="tooltip" title="Подтвержденный ник"><i class="glyphicon glyphicon-ok"></i></div>':'';
