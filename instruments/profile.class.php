...
class Profile extends View {
	...
	public function Show($modal_mode = true) {
		...
		if($this->user->verified()) {
			$user_info['verified']  = array('<div class="label label-success verified_nick" data-toggle="tooltip" data-placement="left" title="Подтвержденный ник"><i class="glyphicon glyphicon-ok"></i> Подтверждено</div>', '');
		}
