...
define('MCR', '3.0S');
define('EX', '3');
define('PROGNAME', 'WoC Engine '.MCR);
define('FEEDBACK', '&copy; 2013-' . date("Y") . ' <a href="http://WorldsOfCubes.NET">WoC Team</a>');
if (!class_exists('MyClass')) :
class ItemLol extends View {
...
const ENCODE = 'utf-8';
	...
	global $config;	
		...
		if(!$config['smtp'])$subject = '=?'.self::ENCODE.'?B?'.base64_encode($subject).'?=';
