...
switch ($method) {
	...
	case 'comment': 
		...
		$comments_item = new Comments_ItemLol(false, 'news/comments/');
    ...
    case 'del_com':
		...
		$comments_item = new Comments_ItemLol((int)$_POST['item_id']);
